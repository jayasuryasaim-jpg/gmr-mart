...
const Heatmap = () => {
  ...
  // Full product list integrated into rows
  const rawData = {
    "Ground Floor": {
    ...
    "Second Floor": {
      ...
      "S2": { label: "HOME ESSENTIALS", stock: 55, items: ["Godrej Digital Safe", "Portronics Extension Box", "Syska LED Bulb", "Philips Table Lamp", "Sleepwell Pillow", "Bombay Dyeing Bedsheet", "Raymond Blanket", "Spaces Luxury Towel", "Eureka Forbes Vacuum", "Prestige Steam Iron", "Livpure Water Purifier", "Luminous Inverter", "Exide Home Battery", "Odonil Air Freshener", "Godrej Aer Spray", "All Out Mosquito Liquid", "Hit Crawling Insect", "Durex Extended Pleasure", "Vicks Vaporub", "Harpic Toilet Cleaner", "Lizol Floor Cleaner", "Comfort Fabric Conditioner", "Surf Excel Matic", "Ariel Top Load", "Vim Dishwash Gel"] },
                          ...
                          <div key={rid} className={`aisle-box ${displayRow === rid || isFound ? 'active' : ''}`}
                            ...
                            <div className="aisle-3d-body">
                              <div className="aisle-fill" style={{ 
                                height: `${stock}%`, 
                                background: fireActive ? '#ff3131' : dynamicColor,
